...
#d) CTU cluster options
export train_cmd="queue.pl -q cpu.q "
export train_big_memory_cmd="queue.pl -q cpu.q -l arch=*64,ram_free=4G,mem_free=4G"
export decode_cmd="queue.pl -q cpu.q "
export mkgraph_cmd="queue.pl -q cpu.q "
export big_memory_cmd="queue.pl -q cpu.q@magi219.feld.cvut.cz -l arch=*64,ram_free=8G,mem_free=8G"
export cuda_cmd="queue.pl -l gpu=1"
